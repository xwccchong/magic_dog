...
#include "moveit_task_constructor_msgs/msg/detail/task_description__rosidl_typesupport_fastrtps_c.h"
...
#include "moveit_task_constructor_msgs/msg/detail/stage_description__functions.h"  // stages
...
using _TaskDescription__ros_msg_type = moveit_task_constructor_msgs__msg__TaskDescription;
  ...
  // Field name: stages
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, moveit_task_constructor_msgs, msg, StageDescription
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: stages
  {
    ...
    if (ros_message->stages.data) {
      moveit_task_constructor_msgs__msg__StageDescription__Sequence__fini(&ros_message->stages);
    }
    if (!moveit_task_constructor_msgs__msg__StageDescription__Sequence__init(&ros_message->stages, size)) {
...
size_t get_serialized_size_moveit_task_constructor_msgs__msg__TaskDescription(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TaskDescription__ros_msg_type * ros_message = static_cast<const _TaskDescription__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name stages
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_moveit_task_constructor_msgs__msg__StageDescription(
...
static uint32_t _TaskDescription__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_moveit_task_constructor_msgs__msg__TaskDescription(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_task_constructor_msgs
size_t max_serialized_size_moveit_task_constructor_msgs__msg__TaskDescription(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: stages
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_moveit_task_constructor_msgs__msg__StageDescription(
  ...
  if (is_plain) {
    ...
    using DataType = moveit_task_constructor_msgs__msg__TaskDescription;
    is_plain =
      (
...
static size_t _TaskDescription__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_moveit_task_constructor_msgs__msg__TaskDescription(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_task_constructor_msgs, msg, TaskDescription)() {
