  ...
  // Field name: stages
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, moveit_task_constructor_msgs, msg, StageStatistics
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _TaskStatistics__ros_msg_type * ros_message = static_cast<_TaskStatistics__ros_msg_type *>(untyped_ros_message);
  // Field name: task_id
  {
    std::string tmp;
    cdr >> tmp;
