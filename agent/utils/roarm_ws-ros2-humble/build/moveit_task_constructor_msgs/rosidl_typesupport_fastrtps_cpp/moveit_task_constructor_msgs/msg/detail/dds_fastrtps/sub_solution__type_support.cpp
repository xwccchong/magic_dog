...
#include "moveit_task_constructor_msgs/msg/detail/sub_solution__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const moveit_task_constructor_msgs::msg::SubSolution & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.sub_solution_id;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moveit_task_constructor_msgs::msg::SubSolution & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: sub_solution_id
  {
    ...
    size_t item_size = sizeof(ros_message.sub_solution_id[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = moveit_task_constructor_msgs::msg::SubSolution;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const moveit_task_constructor_msgs::msg::SubSolution *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<moveit_task_constructor_msgs::msg::SubSolution *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SubSolution__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const moveit_task_constructor_msgs::msg::SubSolution *>(
...
static size_t _SubSolution__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SubSolution(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SubSolution__callbacks = {
...
static rosidl_message_type_support_t _SubSolution__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SubSolution__callbacks,
...
{
  return &moveit_task_constructor_msgs::msg::typesupport_fastrtps_cpp::_SubSolution__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_task_constructor_msgs, msg, SubSolution)() {
  return &moveit_task_constructor_msgs::msg::typesupport_fastrtps_cpp::_SubSolution__handle;
}
