...
#include "moveit_task_constructor_msgs/msg/detail/task_statistics__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const moveit_task_constructor_msgs::msg::StageStatistics &,
  ...
  // Member: stages
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.stages[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: stages
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        moveit_task_constructor_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_StageStatistics(
  ...
  if (is_plain) {
    ...
    using DataType = moveit_task_constructor_msgs::msg::TaskStatistics;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const moveit_task_constructor_msgs::msg::TaskStatistics *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<moveit_task_constructor_msgs::msg::TaskStatistics *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TaskStatistics__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const moveit_task_constructor_msgs::msg::TaskStatistics *>(
...
static size_t _TaskStatistics__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TaskStatistics(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TaskStatistics__callbacks = {
...
static rosidl_message_type_support_t _TaskStatistics__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TaskStatistics__callbacks,
...
{
  return &moveit_task_constructor_msgs::msg::typesupport_fastrtps_cpp::_TaskStatistics__handle;
}
