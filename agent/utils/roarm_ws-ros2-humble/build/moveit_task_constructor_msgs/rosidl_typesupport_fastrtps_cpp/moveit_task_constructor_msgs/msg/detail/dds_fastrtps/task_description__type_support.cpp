...
#include "moveit_task_constructor_msgs/msg/detail/task_description__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const moveit_task_constructor_msgs::msg::StageDescription &,
...
cdr_serialize(
  const moveit_task_constructor_msgs::msg::TaskDescription & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moveit_task_constructor_msgs::msg::TaskDescription & ros_message)
{
  // Member: task_id
  cdr >> ros_message.task_id;
  ...
  size_t current_alignment)
{
  ...
  // Member: stages
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        moveit_task_constructor_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_StageDescription(
  ...
  if (is_plain) {
    ...
    using DataType = moveit_task_constructor_msgs::msg::TaskDescription;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const moveit_task_constructor_msgs::msg::TaskDescription *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<moveit_task_constructor_msgs::msg::TaskDescription *>(
    untyped_ros_message);
...
{
  return &moveit_task_constructor_msgs::msg::typesupport_fastrtps_cpp::_TaskDescription__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_task_constructor_msgs, msg, TaskDescription)() {
  return &moveit_task_constructor_msgs::msg::typesupport_fastrtps_cpp::_TaskDescription__handle;
}
