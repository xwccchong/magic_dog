...
#include "roarm_msgs/msg/detail/servo_status__rosidl_typesupport_fastrtps_c.h"
...
using _ServoStatus__ros_msg_type = roarm_msgs__msg__ServoStatus;
...
size_t get_serialized_size_roarm_msgs__msg__ServoStatus(
  const void * untyped_ros_message,
...
static uint32_t _ServoStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_roarm_msgs__msg__ServoStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roarm_msgs
size_t max_serialized_size_roarm_msgs__msg__ServoStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roarm_msgs__msg__ServoStatus;
    is_plain =
      (
...
static size_t _ServoStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_roarm_msgs__msg__ServoStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roarm_msgs, msg, ServoStatus)() {
