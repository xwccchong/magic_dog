...
#ifndef ROARM_MSGS__SRV__DETAIL__SERVO_COMMAND_TYPE__FUNCTIONS_H_
#define ROARM_MSGS__SRV__DETAIL__SERVO_COMMAND_TYPE__FUNCTIONS_H_
 ...
 * calls
 * roarm_msgs__srv__ServoCommandType_Request__init().
...
/**
 * It calls
 * roarm_msgs__srv__ServoCommandType_Request__fini()
 ...
 * roarm_msgs__srv__ServoCommandType_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * roarm_msgs__srv__ServoCommandType_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * roarm_msgs__srv__ServoCommandType_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roarm_msgs
...
/**
 * It calls
 * roarm_msgs__srv__ServoCommandType_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_roarm_msgs
...
/**
 * It allocates the memory for the array and calls
 * roarm_msgs__srv__ServoCommandType_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roarm_msgs
...
/**
 * It calls
 * roarm_msgs__srv__ServoCommandType_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROARM_MSGS__SRV__DETAIL__SERVO_COMMAND_TYPE__FUNCTIONS_H_
