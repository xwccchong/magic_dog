...
static const _MoveJointCmd_Request_type_support_symbol_names_t _MoveJointCmd_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roarm_msgs, srv, MoveJointCmd_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roarm_msgs, srv, MoveJointCmd_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roarm_msgs, srv, MoveJointCmd_Request)() {
  return &::roarm_msgs::srv::rosidl_typesupport_c::MoveJointCmd_Request_message_type_support_handle;
}
...
static const _MoveJointCmd_Response_type_support_symbol_names_t _MoveJointCmd_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roarm_msgs, srv, MoveJointCmd_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roarm_msgs, srv, MoveJointCmd_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roarm_msgs, srv, MoveJointCmd_Response)() {
  return &::roarm_msgs::srv::rosidl_typesupport_c::MoveJointCmd_Response_message_type_support_handle;
}
...
static const _MoveJointCmd_type_support_symbol_names_t _MoveJointCmd_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roarm_msgs, srv, MoveJointCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roarm_msgs, srv, MoveJointCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, roarm_msgs, srv, MoveJointCmd)() {
  return &::roarm_msgs::srv::rosidl_typesupport_c::MoveJointCmd_service_type_support_handle;
}
