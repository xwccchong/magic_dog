...
static const _MoveCircleCmd_Request_type_support_symbol_names_t _MoveCircleCmd_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roarm_msgs, srv, MoveCircleCmd_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roarm_msgs, srv, MoveCircleCmd_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roarm_msgs, srv, MoveCircleCmd_Request)() {
  return &::roarm_msgs::srv::rosidl_typesupport_c::MoveCircleCmd_Request_message_type_support_handle;
}
...
static const _MoveCircleCmd_Response_type_support_symbol_names_t _MoveCircleCmd_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roarm_msgs, srv, MoveCircleCmd_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roarm_msgs, srv, MoveCircleCmd_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roarm_msgs, srv, MoveCircleCmd_Response)() {
  return &::roarm_msgs::srv::rosidl_typesupport_c::MoveCircleCmd_Response_message_type_support_handle;
}
...
static const _MoveCircleCmd_type_support_symbol_names_t _MoveCircleCmd_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roarm_msgs, srv, MoveCircleCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roarm_msgs, srv, MoveCircleCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, roarm_msgs, srv, MoveCircleCmd)() {
  return &::roarm_msgs::srv::rosidl_typesupport_c::MoveCircleCmd_service_type_support_handle;
}
