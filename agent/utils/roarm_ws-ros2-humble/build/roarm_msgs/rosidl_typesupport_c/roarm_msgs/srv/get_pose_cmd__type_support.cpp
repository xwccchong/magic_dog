...
static const _GetPoseCmd_Request_type_support_symbol_names_t _GetPoseCmd_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roarm_msgs, srv, GetPoseCmd_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roarm_msgs, srv, GetPoseCmd_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roarm_msgs, srv, GetPoseCmd_Request)() {
  return &::roarm_msgs::srv::rosidl_typesupport_c::GetPoseCmd_Request_message_type_support_handle;
}
...
static const _GetPoseCmd_Response_type_support_symbol_names_t _GetPoseCmd_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roarm_msgs, srv, GetPoseCmd_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roarm_msgs, srv, GetPoseCmd_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roarm_msgs, srv, GetPoseCmd_Response)() {
  return &::roarm_msgs::srv::rosidl_typesupport_c::GetPoseCmd_Response_message_type_support_handle;
}
...
static const _GetPoseCmd_type_support_symbol_names_t _GetPoseCmd_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roarm_msgs, srv, GetPoseCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roarm_msgs, srv, GetPoseCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, roarm_msgs, srv, GetPoseCmd)() {
  return &::roarm_msgs::srv::rosidl_typesupport_c::GetPoseCmd_service_type_support_handle;
}
