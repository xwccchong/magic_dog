...
static const _ServoCommandType_Request_type_support_symbol_names_t _ServoCommandType_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roarm_msgs, srv, ServoCommandType_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roarm_msgs, srv, ServoCommandType_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roarm_msgs, srv, ServoCommandType_Request)() {
  return &::roarm_msgs::srv::rosidl_typesupport_c::ServoCommandType_Request_message_type_support_handle;
}
...
static const _ServoCommandType_Response_type_support_symbol_names_t _ServoCommandType_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roarm_msgs, srv, ServoCommandType_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roarm_msgs, srv, ServoCommandType_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roarm_msgs, srv, ServoCommandType_Response)() {
  return &::roarm_msgs::srv::rosidl_typesupport_c::ServoCommandType_Response_message_type_support_handle;
}
...
static const _ServoCommandType_type_support_symbol_names_t _ServoCommandType_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roarm_msgs, srv, ServoCommandType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roarm_msgs, srv, ServoCommandType)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, roarm_msgs, srv, ServoCommandType)() {
  return &::roarm_msgs::srv::rosidl_typesupport_c::ServoCommandType_service_type_support_handle;
}
