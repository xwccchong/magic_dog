...
{
  new (message_memory) roarm_msgs::msg::ServoStatus(_init);
}

void ServoStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<roarm_msgs::msg::ServoStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ServoStatus_message_member_array[2] = {
  {
    ...
    offsetof(roarm_msgs::msg::ServoStatus, code),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(roarm_msgs::msg::ServoStatus, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ServoStatus_message_members = {
  "roarm_msgs::msg",  // message namespace
  "ServoStatus",  // message name
  2,  // number of fields
  sizeof(roarm_msgs::msg::ServoStatus),
...
{
  return &::roarm_msgs::msg::rosidl_typesupport_introspection_cpp::ServoStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, roarm_msgs, msg, ServoStatus)() {
  return &::roarm_msgs::msg::rosidl_typesupport_introspection_cpp::ServoStatus_message_type_support_handle;
}
