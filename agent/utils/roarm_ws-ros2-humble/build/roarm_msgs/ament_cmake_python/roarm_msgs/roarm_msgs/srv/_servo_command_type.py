...
class Metaclass_ServoCommandType(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'roarm_msgs.srv.ServoCommandType')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from roarm_msgs.srv import _servo_command_type
...
class ServoCommandType(metaclass=Metaclass_ServoCommandType):
    from roarm_msgs.srv._servo_command_type import ServoCommandType_Request as Request
    from roarm_msgs.srv._servo_command_type import ServoCommandType_Response as Response
