...
#include "roarm_msgs/srv/detail/servo_command_type__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const roarm_msgs::srv::ServoCommandType_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  roarm_msgs::srv::ServoCommandType_Request & ros_message)
{
  // Member: command_type
  cdr >> ros_message.command_type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roarm_msgs::srv::ServoCommandType_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const roarm_msgs::srv::ServoCommandType_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<roarm_msgs::srv::ServoCommandType_Request *>(
    untyped_ros_message);
...
{
  return &roarm_msgs::srv::typesupport_fastrtps_cpp::_ServoCommandType_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roarm_msgs, srv, ServoCommandType_Request)() {
  return &roarm_msgs::srv::typesupport_fastrtps_cpp::_ServoCommandType_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_roarm_msgs
cdr_serialize(
  const roarm_msgs::srv::ServoCommandType_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  roarm_msgs::srv::ServoCommandType_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = roarm_msgs::srv::ServoCommandType_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const roarm_msgs::srv::ServoCommandType_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<roarm_msgs::srv::ServoCommandType_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &roarm_msgs::srv::typesupport_fastrtps_cpp::_ServoCommandType_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roarm_msgs, srv, ServoCommandType_Response)() {
  return &roarm_msgs::srv::typesupport_fastrtps_cpp::_ServoCommandType_Response__handle;
}
...
{
  return &roarm_msgs::srv::typesupport_fastrtps_cpp::_ServoCommandType__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roarm_msgs, srv, ServoCommandType)() {
  return &roarm_msgs::srv::typesupport_fastrtps_cpp::_ServoCommandType__handle;
}
