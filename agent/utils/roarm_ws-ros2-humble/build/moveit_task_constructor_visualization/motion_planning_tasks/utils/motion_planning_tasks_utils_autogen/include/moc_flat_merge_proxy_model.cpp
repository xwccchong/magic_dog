...
#include <memory>
#include "../../../../../../src/roarm_else/moveit_task_constructor/visualization/motion_planning_tasks/utils/flat_merge_proxy_model.h"
...
void moveit_rviz_plugin::utils::FlatMergeProxyModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FlatMergeProxyModel *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject moveit_rviz_plugin::utils::FlatMergeProxyModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractItemModel::staticMetaObject>(),
    qt_meta_stringdata_moveit_rviz_plugin__utils__FlatMergeProxyModel.data,
    qt_meta_data_moveit_rviz_plugin__utils__FlatMergeProxyModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
