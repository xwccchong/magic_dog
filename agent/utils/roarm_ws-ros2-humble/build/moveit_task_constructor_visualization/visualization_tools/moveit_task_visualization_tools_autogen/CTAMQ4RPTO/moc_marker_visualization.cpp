...
#include <memory>
#include "../../../../../src/roarm_else/moveit_task_constructor/visualization/visualization_tools/include/moveit/visualization_tools/marker_visualization.h"
...
void moveit_rviz_plugin::MarkerVisualizationProperty::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MarkerVisualizationProperty *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (MarkerVisualizationProperty::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject moveit_rviz_plugin::MarkerVisualizationProperty::staticMetaObject = { {
    QMetaObject::SuperData::link<rviz_common::properties::BoolProperty::staticMetaObject>(),
    qt_meta_stringdata_moveit_rviz_plugin__MarkerVisualizationProperty.data,
    qt_meta_data_moveit_rviz_plugin__MarkerVisualizationProperty,
    qt_static_metacall,
    nullptr,
    nullptr
} };
