#pragma message("#include \"pick_place_parameters.hpp\" is deprecated. Use #include <roarm_moveit_mtc_demo/pick_place_parameters.hpp> instead.")
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    void declare_params(){
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "execute") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.execute = param.as_bool();
      param = parameters_interface_->get_parameter(prefix_ + "table_name");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "table_name") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "table_reference_frame") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "table_dimensions") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = fixed_size<double>(param, 3);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "table_pose") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = fixed_size<double>(param, 6);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "object_name") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "object_reference_frame") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "object_dimensions") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = fixed_size<double>(param, 2);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "object_pose") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = fixed_size<double>(param, 6);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "spawn_table") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.spawn_table = param.as_bool();
      param = parameters_interface_->get_parameter(prefix_ + "max_solutions");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "max_solutions") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.max_solutions = param.as_int();
      param = parameters_interface_->get_parameter(prefix_ + "arm_group_name");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "arm_group_name") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "eef_name") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "hand_group_name") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "hand_frame") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "hand_open_pose") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "hand_close_pose") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "arm_home_pose") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "surface_link") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = not_empty<std::string>(param);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "grasp_frame_transform") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = fixed_size<double>(param, 6);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "place_pose") << ": " << param.get_type_name() << " = " << param.value_to_string());
      if(auto validation_result = fixed_size<double>(param, 6);
        !validation_result) {
      ...
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "place_surface_offset") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.place_surface_offset = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "approach_object_min_dist");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "approach_object_min_dist") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.approach_object_min_dist = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "approach_object_max_dist");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "approach_object_max_dist") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.approach_object_max_dist = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "lift_object_min_dist");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "lift_object_min_dist") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.lift_object_min_dist = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "lift_object_max_dist");
      RCLCPP_DEBUG_STREAM(logger_, (prefix_ + "lift_object_max_dist") << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.lift_object_max_dist = param.as_double();
