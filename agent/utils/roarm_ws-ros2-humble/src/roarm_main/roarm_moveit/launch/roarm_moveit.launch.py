...
def generate_launch_description():
    ...
    # Use regular Node instead of add_debuggable_node to avoid OpenGL issues
    ld.add_action(
        Node(
            ...
            # Set environment variables for headless operation (no display needed)
            additional_env={
                "DISPLAY": "",
    ...
    # Only start RViz if use_rviz is True
    ld.add_action(
        Node(
            package="rviz2",
            executable="rviz2",
