...
#ifndef ROARM_MSGS__MSG__DETAIL__SERVO_STATUS__STRUCT_HPP_
#define ROARM_MSGS__MSG__DETAIL__SERVO_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__roarm_msgs__msg__ServoStatus __attribute__((deprecated))
#else
# define DEPRECATED__roarm_msgs__msg__ServoStatus __declspec(deprecated)
#endif
...
struct ServoStatus_
{
  ...
  // pointer types
  using RawPtr =
    roarm_msgs::msg::ServoStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const roarm_msgs::msg::ServoStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<roarm_msgs::msg::ServoStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<roarm_msgs::msg::ServoStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      roarm_msgs::msg::ServoStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<roarm_msgs::msg::ServoStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<roarm_msgs::msg::ServoStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<roarm_msgs::msg::ServoStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<roarm_msgs::msg::ServoStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__roarm_msgs__msg__ServoStatus
    std::shared_ptr<roarm_msgs::msg::ServoStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__roarm_msgs__msg__ServoStatus
    std::shared_ptr<roarm_msgs::msg::ServoStatus_<ContainerAllocator> const>
...
using ServoStatus =
  roarm_msgs::msg::ServoStatus_<std::allocator<void>>;
...
#endif  // ROARM_MSGS__MSG__DETAIL__SERVO_STATUS__STRUCT_HPP_
