...
示例1（明确了送达目的地）："把外卖从门口拿来放到办公室" 
输出：{"item": "外卖", "action_plan": [{"action": "stand_up"}, {"action": "navigate", "location": "门口"}, {"action": "squat"}, {"action": "send_grasp_msg", "item": "外卖"}, {"action": "wait_for_back"}, {"action": "stand_up"}, {"action": "navigate", "location": "办公室"}, {"action": "squat"}, {"action": "release_item"}, {"action": "wait_for_play"}, {"action": "play_audio"}]}

示例2（未说明送达地）："去帮我到前台拿瓶水"
输出：{"item": "水", "action_plan": [{"action": "stand_up"}, {"action": "navigate", "location": "前台"}, {"action": "squat"}, {"action": "send_grasp_msg", "item": "水"}, {"action": "wait_for_back"}, {"action": "stand_up"}, {"action": "navigate", "location": "__DEPARTURE__"}, {"action": "squat"}, {"action": "release_item"}, {"action": "wait_for_play"}, {"action": "play_audio"}]}
