...
async def send_nav_goal(poses_list, location_name=""):
    ...
    try:
        # 在这里将未来的导航点（包括中间点）转化为json，通过底层c的接口发送给底层宇树的slam控制
