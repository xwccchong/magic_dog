...
from task_manager_v5 import TaskManager, TaskType,TaskStatus
...
location_poses_mapping = {
    ...
    "吧台": [
        (1.58285 , -2.14908, 0.0377097, 0.0831981, 0.0913278, -0.607169, 0.78491)
    ],
    "初始位置": [
...
async def execute_sub_task(sub_task):
    ...
    if task_type == TaskType.NAVIGATE:
        ...
        # await asyncio.sleep(2)  # 给机械臂2秒钟让爪子彻底松开脱离
        task_manager.complete_current_sub_task()
        
    elif task_type == TaskType.WAIT_FOR_PLAY:
        print("⏳ 触发挂起：等待机械臂 'play' 信号的异步回传...")
